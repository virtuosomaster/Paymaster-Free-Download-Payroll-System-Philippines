...
<head>
	...
	<style type="text/css" media="screen">
		...
		p { padding-bottom: 12px!important;display:block!important  } 
					...
					<tr>
						<td align="center">
							<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://payrollmaster.ph/wp-content/uploads/elementor/thumbs/pmlogols-qgtqx6dwjarw3ces9weyzt30o7rd0vov4n7a20fxxo.png" editable="true" border="0" alt="" /></td>
																	</tr>
																</table>
															</th>
															...
															<th class="column" width="120" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="text-header right" style="color:#000000; font-family:'Fira Mono', Arial,sans-serif; font-size:12px; line-height:16px; text-align:right;"><multiline><a href="<?php echo $siteHostAdmin; ?>" target="_blank" class="link" style="color:#000001; text-decoration:none;"><span class="link" style="color:#000001; text-decoration:none;">Login</span></a></multiline></td>
																	</tr>
																</table>
															</th>
														</tr>
															...
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	<td class="box" style="padding:40px 30px; border:1px solid #ffffff;">
																		<table width="100%" border="0" cellspacing="0" cellpadding="0">
																			<tr>
																				<td class="h3-white pb20" style="color:#000; font-family:'Ubuntu', Arial,sans-serif; font-size:18px; text-align:center; font-weight:normal; padding-bottom:20px;"><?php echo $message; ?></td>
																			</tr>
																		</table>
																	</td>
																</tr>
											...
											<tr>
												<td class="footer" style="padding: 0px 30px 30px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															<td class="text-socials" style="color:#000000; font-size:16px; line-height:22px; text-align:center; text-transform:uppercase;"><multiline>Visit us</multiline></td>
														</tr>
														<tr>
															<td style="padding: 0px 0px 30px 0px;color:#000000; font-size:10px; line-height:22px; text-align:center;">
																<a href="http://www.payrollmaster.ph/">www.payrollmaster.ph</a><br/>
																<a  href="mailto:info@wptaskforce.com">info@wptaskforce.com</a><br/>
																<a  href="tel:0335010241">(033) 501 0241</a>  | <a href="tel:0333332778">(033) 333 2778</a><br/>
															</td>
														</tr>
													</table>
												</td>
								...
								<tr>
									<td class="text-footer" style="padding: 30px 15px; color:#9fadd4; font-family:'Fira Mono', Arial,sans-serif; font-size:12px; line-height:22px; text-align:center;">
										<multiline>Payroll Master &copy; <?php echo date('Y'); ?> All rights reserved</multiline>
									</td>
								</tr>
							</table>
						</td>
