...
<?php
  ...
  $available_sil = $leave_info->get_user_sil( $user_data->id ) ?: 0;
  ...
  <div class="">
    ...
    <div class="">
      ...
      <div class="row">
              ...
              <div class="row">
                <form id="sssLoan-form" class="form-inline container loan-amortization" data-id="<?php echo $user_data->id; ?>">
                  <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                      <button id="submitSSSLoan" type="submit" class="btn btn-primary pm-blue btn-lg">Save</button>
                      </div>
                  </div>
                </form>
        ...
        <div id="leave-info-wrapper" class="col-md-6 wptf-section">
          <div class="card mb-3">
            <div class="card-header">
              Leave Information
            </div>
            <div class="card-body">
              <div class="row">
                <form id="availSil-form" class="form-inline row" data-id="<?php echo $user_data->id; ?>">
                  <div class="col-sm-4">
                    <label for="availSil" class="col-form-label">Total SIL</label>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="availSil" name="avail_sil" placeholder="0" value="<?php echo $available_sil; ?>" />
                  </div>
                  <div class="col-sm-2">
                    <button id="submitAvailSil" type="submit" class="btn btn-primary pm-blue btn-lg">Save</button>
                  </div>
                </form>
              </div>
              <div class="row mt-3">
                <div class="col-sm-3">
                  <label for="usedSil" class="col-form-label">Total Availed SIL</label>
                </div>
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="usedSil" value="<?php echo ( $used_sil >= $available_sil ? $available_sil : $used_sil ); ?>" readonly />
                </div>
              </div>
              <div class="row mt-3">
                <div class="col-sm-3">
                  <label for="remSil" class="col-form-label">Available SIL</label>
                </div>
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="remSil" value="<?php echo $remaining_sil; ?>" readonly />
                </div>
              </div>
            </div> <!-- Body Card -->
          </div> <!-- Card wrapper -->
        </div> <!-- leave-information-wrapper -->
              ...
              <div class="col-md-12 mb-6">
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-primary pm-blue btn-lg">Save Leave</button>
                  </div>
                </div><!--  card  --> 
              </div>     
            </div>  
              ...
              <div class="col-md-12 mb-6">
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-primary pm-blue btn-lg">Save Schedule</button>
                  </div>
                </div><!--  card  --> 
              </div>     
            </div>  
    ...
    <form id="updateUserLeave-form">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="submit" class="btn btn-primary pm-blue btn-lg">Update / Approve Leave</button>
        </div>
      </div>
    ...
    <form id="updateSchedule-form">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="submit" class="btn btn-primary pm-blue btn-lg">Update Schedule</button>
        </div>
      </div>
      ...
      <div class="modal-body">
        <section class="row">
            ...
            <form id="filemanager-form">
              ...
              <button type="submit" class="btn btn-primary pm-blue btn-lg">Save File</button>
            </form>
            </div>
        </section>
      </div>
